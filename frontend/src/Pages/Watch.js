...
//     }}
//   >
//     <h3 style={{ margin: 0, fontSize: 16 }}>📢 Sponsored</h3>
//     <p style={{ margin: "6px 0", color: "#aaa", fontSize: 13 }}>
//       Upgrade to MyTube Premium for an uninterrupted, ad-free experience.
//     </p>
//     <button
...
//   //     `http://localhost:5000/api/videos/ad/${videoId}`
//   //   );
//   //   if (res.data) {
//   //     fetchAd(res.data._id);
//   //     setAd(res.data);
...
//     try {
//       const res = await axios.get(
//         `http://localhost:5000/api/ads/${videoId}`
//       );
//   http://localhost:5000/api/stream/${video.filename}
//       console.log("🟡 AD RESPONSE:", res.data);
...
//     <div style={styles.adGlow}></div>
//     <h3 style={styles.adTitle}>📢 Sponsored Content</h3>
//     <p style={styles.adText}>
//       Upgrade to MyTube Premium for an uninterrupted, ad-free experience with exclusive features.
//     </p>
...
//   // Poll for summary updates every 10 seconds if pending
//   useEffect(() => {
...
//     if (newQuality === 'auto') {
//       targetQuality = getAutoQuality();
//       console.log("Auto-selected quality:", targetQuality);
//     }
...
//   // Get AI Insights status message
...
//                   style={{
//                     ...styles.overlayBtn, 
//                     background: showSubtitles ? "#ff0000" : "rgba(0,0,0,0.8)"
//                   }}
//                   disabled={!captionsAvailable}
//                   title="Subtitles/CC"
//                 >
...
//                 <button onClick={toggleFullscreen} style={styles.overlayBtn} title="Fullscreen">
//                   <FiMaximize size={20} />
//                 </button>
//               </div>
//             </div>
...
//                 <h3 style={styles.neonTitle}>
//                   <FiCpu style={{marginRight: 8}}/> 
//                   AI NEON INSIGHTS
//                 </h3>
//                 {aiInsights.status === "ready" && aiInsights.sentiment && (
//                   <span style={styles.sentimentBadge}>{aiInsights.sentiment}</span>
//                 )}
//               </div>
...
//                     <p key={i} style={styles.bullet}>• {line.trim()}</p>
//                   ))
//                 ) : (
//                   <p style={styles.loadingText}>
//                     {getAIInsightsMessage()}
//                   </p>
//                 )}
//               </div>
//             </div>
...
//                     {comment.trim() && (
//                       <div style={styles.commentActions}>
//                         <button onClick={() => setComment("")} style={styles.cancelButton}>
//                           Cancel
//                         </button>
//                         <button onClick={postComment} style={styles.commentButton}>
//                           Comment
//                         </button>
//                       </div>
//                     )}
...
//                           <FiThumbsDown size={16} />
//                         </button>
//                         <button style={styles.commentActionBtn}>Reply</button>
//                       </div>
//                     </div>
//                   </div>
//                 ))}
...
//                     onClick={() => navigate(`/watch/${v.filename}`)}
//                   >
//                     <div style={styles.recommendedThumbnail}>
//                       <img 
//                         src={`http://localhost:5000/uploads/${v.thumbnail}`}
//                         alt={v.title}
...
//                     </div>
//                     <div style={styles.recommendedInfo}>
//                       <h4 style={styles.recommendedTitle}>{v.title}</h4>
//                       <p style={styles.recommendedChannel}>
//                         {v.uploadedBy?.name || 'Unknown Channel'}
//                       </p>
//                       <div style={styles.recommendedStats}>
//                         <span>{formatViews(v.views)} views</span>
//                         <span style={styles.dot}>•</span>
...
//   FiThumbsUp, FiThumbsDown, FiShare2, FiBell, FiCheck, 
//   FiZap, FiMoreVertical, FiChevronDown, FiChevronUp, FiCpu,
//   FiMaximize, FiSend, FiTrendingUp, FiEye, FiClock, FiHeart
// } from "react-icons/fi";
// import { 
//   MdOutlineScreenShare, 
//   MdOutlineFullscreenExit, 
...
//       // ✅ Backend automatically sends notification to video owner
...
//       // ✅ Backend automatically sends notification to channel owner
...
//   /* ================= 🔔 POST COMMENT WITH NOTIFICATION ================= */
//   // const postComment = async () => {
//   //   if (!comment.trim() || !user) return;
...
//   //     // Refresh comments to get the real one from server
//   //     fetchComments(video._id); 
//   //   } catch (error) {
...
//     // ✅ Optimistic UI (user as object, not string)
//     const tempComment = {
//       _id: Date.now(),
//       user: {
//         _id: user._id,
...
//       // 🔁 Replace temp comment with real one (BEST UX)
//       setVideo(p => ({
//         ...p,
