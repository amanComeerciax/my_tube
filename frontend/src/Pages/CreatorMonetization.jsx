...
//       const res = await axios.get("http://localhost:5000/api/monetization/status", {
...
//     try {
//       const token = localStorage.getItem("token");
//       const res = await axios.get("http://localhost:5000/api/monetization/dashboard", {
//         headers: { Authorization: `Bearer ${token}` }
//       });
...
//       const token = localStorage.getItem("token");
//       await axios.post(
//         "http://localhost:5000/api/monetization/payment-info",
//         paymentInfo,
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//       const token = localStorage.getItem("token");
//       const res = await axios.post(
//         "http://localhost:5000/api/monetization/request-payout",
//         {},
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
...
//   // NOT APPLIED YET - Show eligibility check
//   if (!status?.applied) {
//     const { currentStats, requiredThresholds } = status;
...
//                   <img 
//                     src={`http://localhost:5000/uploads/${item._id.thumbnail}`}
//                     alt={item._id.title}
...
// /* ================= UPDATE FOR WATCH.JSX =================
//  * In your Watch.jsx file, update the Skip Ad button click handler:
//  * 
//  * From:
//  *   onClick={() => { setShowAd(false); setAdTime(0); }}
//  * 
//  * To:
//  *   onClick={async () => {
//  *     // Track ad click
...
//  *   }}
//  * 
//  * This will properly track clicks and credit revenue to the creator!
//  */
